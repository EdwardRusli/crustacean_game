...
var customers = [
	...
	["random", ["plate_tortilla_kelp", "plate_tortilla_meat"],40],
	["random", ["plate_tortilla_kelp", "plate_tortilla_meat"],40],
	["random", ["plate_tortilla_kelpmeat_salsa", "coconut_umbrellablue"],40],
	["random", ["plate_tortilla_kelpmeat", "coconut_umbrellapink"],40],
	["squidkid", ["plate_tortilla_kelpmeat_mayo", "plate_tortilla_meat_salsa", "coconut", "coconut"],45, ["I’m a huge fan of Colossal Squid! He’s so COOL!",
	"Squid Kid: If I eat as much as he does, will I grow as big and strong as him?"
	], [1],"res://sprites/customers/squid kid.png"],
	["jelly_fish", ["plate_tortilla_kelp"],40, [
		"Jelly Fish: Sir, please I have yet to gain any sustenance for days.",
		"I am, unfortunately, not currently in the position of owning any currency.",
		"But, if you will, I might be able to finally eat today.",
		"You will be blessed.",
		"How far has this world fallen?"
	], [2],"res://sprites/customers/angler fish/angler fish angwy.png"],
...
func end_day():
	if (!has_ended&&served_customers == customers.size()):
		...
		get_tree().change_scene_to_file("res://scenes/level4.tscn") # what do you want
