...
var customers = [
	...
	["random", ["plate_bread_cheese_ham_cooked", "plate_bread_kelp_cooked", "plate_bread_cheese_kelp_cooked"],50],
	["random", ["plate_tortilla_kelpmeat_mayo", "plate_tortilla_kelpmeat_mayo"],50],
	["random", ["shavedice_syrup", "shavedice_syrup", "plate_tortilla_meat_salsa", "coconut_umbrellablue"],50],
	["random", ["shavedice_syrup", "plate_bread_ham_cooked", "coconut"],50],
	["random", ["plate_tortilla_kelp", "plate_tortilla_kelp", "plate_bread_cheese_cooked", "plate_bread_cheese_cooked"],50],
	["random", ["shavedice_syrup", "shavedice_syrup", "plate_tortilla_meat_salsa", "plate_tortilla_kelpmeat"],50],
	["random", ["shavedice_syrup", "plate_bread_kelp_ham_cooked", "plate_tortilla_meat_mayo", "coconut"],50],
	["random", ["plate_tortilla_meat", "plate_tortilla_meat", "plate_bread_cheese_cooked", "shavedice_syrup"],50],
...
func end_day():
	if (!has_ended&&served_customers == customers.size()):
		...
		get_tree().change_scene_to_file("res://scenes/cutscene_normalending.tscn") # what do you want
